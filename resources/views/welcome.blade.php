...
<body class="font-sans antialiased dark:bg-black dark:text-white/50">
    <h1 class="text-red-500 font-bold text-4xl">Hallo</h1>
    ...
    <div
        class="fixed z-50 w-full h-16 max-w-sm -translate-x-1/2 bg-white border border-gray-200 rounded-full bottom-4 left-1/2 dark:bg-gray-700 dark:border-gray-600">
