...
<body class="font-sans antialiased bg-white ">
    ...
    <div class="section max-w-md mx-auto bg-fe-primary">
        ...
        <div
            class="fixed z-40 w-full h-16 max-w-sm -translate-x-1/2 bg-white border border-gray-200 rounded-full bottom-4 left-1/2 dark:bg-gray-700 dark:border-gray-600">
